...
public class MysqlSchedulerTest {
    ...
    protected Properties createSchedulerProperties(String name, int threadPoolSize) {
        ...
        properties.put("org.quartz.scheduler.instanceName", name); // "TestScheduler"
        properties.put("org.quartz.scheduler.instanceId", "AUTO");
        properties.put("org.quartz.scheduler.skipUpdateCheck", "true");
        properties.put("org.quartz.threadPool.class", "org.quartz.simpl.SimpleThreadPool");
        properties.put("org.quartz.threadPool.threadCount", "" + threadPoolSize);  // "12"
        ...
        properties.put("org.quartz.jobStore.driverDelegateClass", "org.quartz.job.jdbcjobstore.MSSQLDelegate"); // StdJDBCDelegate
        ...
        properties.put("org.quartz.dataSource.myDS.URL", "jdbc:mysql://localhost:3306/quartz_test");
    ...
    private Scheduler createScheduler(String name, int threadPoolSize) throws SchedulerException {
        Properties schedulerProperties = createSchedulerProperties(name, threadPoolSize);
        StdSchedulerFactory stdSchedulerFactory = new StdSchedulerFactory(schedulerProperties);
