...
public class CronTriggerImpl extends AbstractTrigger<CronTrigger> implements CronTrigger, CoreTrigger {
     ...
     * @param jobName        name of the <code>{@link JobDetail}</code>
     *                       executed on firetime
     * @param jobGroup       group of the <code>{@link JobDetail}</code>
     *                       executed on firetime
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(org.quartz.spi.OperableTrigger, org.quartz.calendar.Calendar, java.util.Date, java.util.Date)
     */
    @Override
     ...
     */
    @Override
    public void updateAfterMisfire(org.quartz.calendar.Calendar cal) {
     ...
     */
    @Override
    public void triggered(org.quartz.calendar.Calendar calendar) {
    ...
    /**
     * @see AbstractTrigger#updateWithNewCalendar(org.quartz.calendar.Calendar, long)
     */
    @Override
    public void updateWithNewCalendar(org.quartz.calendar.Calendar calendar, long misfireThreshold) {
     ...
     */
    @Override
    public Date computeFirstFireTime(org.quartz.calendar.Calendar calendar) {
