 ...
 * as, for example, {@link org.quartz.calendar.WeeklyCalendar
...
public class DailyCalendar extends BaseCalendar {
     ...
     *                          time range
     */
    public DailyCalendar(org.quartz.calendar.Calendar baseCalendar,
     ...
     * <code>{@link TimeZone#getDefault()}</code> time zone unless an explicit
     * time zone is set via <code>{@link BaseCalendar#setTimeZone(TimeZone)}</code>.
     * You should use <code>{@link #DailyCalendar(org.quartz.calendar.Calendar, java.util.TimeZone, long, long)}</code>
