 ...
 * <code>{@link org.quartz.job.jdbcjobstore.StdJDBCDelegate}</code> class.
 * </p>
 *
...
public interface DriverDelegate {
     ...
     *
     * @param conn    the DB Connection
     * @param matcher the group matcher to evaluate against the known jobs
     ...
     *
     * @param conn      the DB connection
     * @param matcher   the group matcher to evaluate against the known triggers
     * @param newState  the new state for the trigger
     * @param oldState1 one of the old state the trigger must be in
     * @param oldState2 one of the old state the trigger must be in
     * @param oldState3 one of the old state the trigger must be in
     ...
     *
     * @param conn     the DB connection
     * @param matcher  the matcher to evaluate against the known triggers
     ...
     * @param conn     the DB Connection
     * @param state    the new state for the triggers
     * @param oldState the old state of the triggers
     * @return the number of rows updated
     */
