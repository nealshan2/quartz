...
import org.quartz.scheduler.DefaultThreadExecutor;
import org.quartz.matchers.GroupMatcher;
import org.quartz.matchers.StringMatcher;
import org.quartz.matchers.StringMatcher.StringOperatorName;
...
public abstract class JobStoreSupport implements JobStore, Constants {
     ...
     * </p>
     *
     * @see #resumeJobs(org.quartz.matchers.GroupMatcher)
     */
    @SuppressWarnings("unchecked")
     ...
     * </p>
     *
     * @see #pauseJobs(org.quartz.matchers.GroupMatcher)
     */
    @SuppressWarnings("unchecked")
     ...
     * </p>
     *
     * @see #resumeTriggerGroup(java.sql.Connection, org.quartz.matchers.GroupMatcher)
     */
    @SuppressWarnings("unchecked")
     ...
     * </p>
     *
     * @see #resumeTriggers(org.quartz.matchers.GroupMatcher)
     */
     ...
     *
     * @see #resumeAll()
     * @see #pauseTriggerGroup(java.sql.Connection, org.quartz.matchers.GroupMatcher)
     */
