...
import org.quartz.calendar.CalendarIntervalScheduleBuilder;
import org.quartz.calendar.CalendarIntervalTrigger;
...
public class CalendarIntervalTriggerImpl extends AbstractTrigger<CalendarIntervalTrigger> implements CalendarIntervalTrigger, CoreTrigger {
     ...
     * </p>
     *
     * @throws IllegalArgumentException if repeatInterval is < 1
     */
    ...
    /**
     * @see org.quartz.spi.OperableTrigger#updateWithNewCalendar(org.quartz.calendar.Calendar, long)
     */
    @Override
